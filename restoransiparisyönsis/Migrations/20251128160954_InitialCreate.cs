...
namespace restoransiparisyönsis.Migrations
{
    /// <inheritdoc />
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "EkstraMalzemeAd", "EkstraMalzemeFiyat" },
                values: new object[,]
                {
                    { 1, "Ketçap", 2m },
                    { 2, "Mayonez", 2m },
            ...
            migrationBuilder.InsertData(
                table: "Menuler",
                columns: new[] { "Id", "MenuAd", "MenuFiyat", "ResimYolu", "Stok" },
                values: new object[,]
                {
                    { 1, "Cheeseburger Menü", 100m, "cheeseburger-menu.png", 100 },
                    { 2, "BigKing Menü", 120m, "big-king-menu.png", 100 },
                    { 3, "King Chicken Menü", 110m, "king-chicken-menu.png", 100 },
                    { 4, "Karışık Izgara", 450m, "izgara.jpg", 50 },
                    { 5, "Adana Kebap", 320m, "adana.jpg", 80 },
                    { 6, "Fıstıklı Baklava", 180m, "baklava.jpg", 100 },
                    { 7, "Sütlaç", 90m, "sutlac.jpg", 50 },
                    { 8, "Yayık Ayran", 40m, "ayran.jpg", 200 },
                    { 9, "Cola Zero", 50m, "cola.jpg", 200 }
                });
